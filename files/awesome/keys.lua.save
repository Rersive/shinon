...
-- Awesome
  ...
  -- Opacity
  awful.key({ mod, "+" }, "KP_Subtract", function()
    awful.spawn("picom-trans -c -o -3", true)
  end),
  awful.key({ mod, "-" }, "KP_Add", function()
    awful.spawn("picom-trans -c -o +3", true)
  end),
  ...
  -- Change Wallpaper
  awful.key({mod}, "i", function() help.randomize_wallpaper() end),
  -- Applications
  awful.key({ mod }, 'Return', function() awful.util.spawn('kitty') end),
  awful.key({ mod }, 'w', function() awful.util.spawn('brave') end),
  awful.key({ mod }, 'f', function() awful.util.spawn('dolphin') end),
  awful.key({ mod }, 'ñ', function() awful.util.spawn('discord') end),
  awful.key({ mod }, ',', function() awful.util.spawn('audiorelay') end),
  awful.key({ mod }, 'p', function() awful.util.spawn('spotify') end),
  awful.key({ mod }, 'g', function() awful.util.spawn('rofi -show drun -show-icons -theme apps') end),
